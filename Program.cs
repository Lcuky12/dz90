...
namespace ConsoleApp95
{
    ...
    class Salesman
    {
        ...
        private List<Player> _productList = new List<Player>();
        ...
        public void ShowAllPlayerBag()
        {
            for (int i = 0; i < _productList.Count; i++)
            {
                _productList[i].ShowPlayerBag();
            }
        }
    ...
    class Player
    {
        ...
        public Player(int money, int bag)
        {
            _money = money;          
            _bag = bag;
        }
        ...
        {
            Console.WriteLine($"Денег у игрока - {_money} рублей, купленный товар - {_bag}");
        }
